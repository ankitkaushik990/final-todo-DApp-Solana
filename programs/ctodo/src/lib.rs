...
declare_id!("6AcPyWbhrMQiYz4jdiw8pGLbDtqRXqthoR29EbunoQ2b");
...
pub mod ctodo{
    ...
    pub fn mark_todo(ctx: Context<MarkTodo>, todo_idx:u8)-> Result<()>{
        //Change the mark of todo to true or marked as completed 

        let todo_account = &mut ctx.accounts.todo_account;
        require!(!todo_account.marked, TodoError::AlredyMarked);
